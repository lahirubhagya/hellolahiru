    ...
    <tr>
        <td style="padding: 40px 0;">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                ...
                <!-- Hero message -->
                <tr>
                    <td bgcolor="#ffffff" style="padding: 44px 40px 32px 40px; text-align: center;">
                        <p style="margin: 0 0 8px 0; font-size: 13px; letter-spacing: 3px; text-transform: uppercase; color: #F68338; font-weight: 600;">
                            Message Received
                        </p>
                        <h1 style="margin: 0 0 16px 0; font-size: 28px; font-weight: 600; color: #111111; line-height: 1.3;">
                            Thanks for reaching out, {{ $data->name }}!
                        </h1>
                        <p style="margin: 0; font-size: 15px; color: #666666; line-height: 1.8; max-width: 440px; margin: 0 auto;">
                            I've received your message and will get back to you as soon as possible —
                            usually within <strong style="color: #111111;">24–48 hours</strong>.
                        </p>
                    </td>
                </tr>
